...
export const dummyResumeData = [
    ...
    },
    {
        ...
        skills: ["Node.js", "Python", "PostgreSQL", "Docker", "Kubernetes", "CI/CD", "Redis", "GraphQL", "AWS"],
        experience: [
            {
        ...
        project: [
            {
                ...
                description: "Invoicr is a secure web platform that allows freelancers and small businesses to generate, track, and automate professional invoices. Built with Node.js, PostgreSQL, and Stripe integration.",
